...
public class RadioComponent implements UIComponent{
    private final String id, name, label, textColor, parent;
    private final String[] optionIds;
    private final JSONObject options;

    public RadioComponent(String id, String name, String label, String textColor, String parent,
    ...
    public RadioComponent(JSONObject data) throws JSONException {
        this(
                data.getString("id"),
                data.getString("name"),
